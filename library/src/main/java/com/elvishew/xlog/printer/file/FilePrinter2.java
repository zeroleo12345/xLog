 ...
 * <p>
 * Use the {@link Builder} to construct a {@link FilePrinter2} object.
 */
public class FilePrinter2 implements Printer {
   ...
   */
  private final FileNameGenerator2 fileNameGenerator;
  ...
  void doPrintln(int logLevel, String tag, String msg) {
    ...
    if (lastFileName == null || fileNameGenerator.isFileNameChangeable()) {
      String newFileName = fileNameGenerator.generateFileName(logLevel, tag, System.currentTimeMillis());
  ...
  public static class Builder {
     ...
     * The file name generator for log file.
     */
    FileNameGenerator2 fileNameGenerator;
     ...
     * @return the builder
     */
    public Builder fileNameGenerator(FileNameGenerator2 fileNameGenerator) {
    ...
    /**
     * Build configured {@link FilePrinter2} object.
     *
     * @return the built configured {@link FilePrinter2} object
     */
    public FilePrinter2 build() {
      fillEmptyFields();
      return new FilePrinter2(this);
    }

    private void fillEmptyFields() {
      if (fileNameGenerator == null) {
        fileNameGenerator = DefaultsFactory.createFileNameGenerator2();
      }
